...
In equilibrium, creditors have to be indifferent regarding lending to a young individual with a collateral coverage $v$ and investing in the asset that yields $R_f$. Since $\epsilon$ is the risk of default and creditors are risk-neutral, and since $R_f v$ is the middle-age value of pledgeable collateral per dollar borrowed, the non-arbitrage condition is given by: 
