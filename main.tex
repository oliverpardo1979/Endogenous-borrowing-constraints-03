...
Aggregate welfare is given by Equation (\ref{eq:aggW}). Since $\mathcal{N}>0$, an increase in $(1-\eta)\tau_y$ weakly decreases $W$ by increasing the measure of young individuals who cannot finance the alternative investment; the decrease is strict whenever the implied thresholds lie in the support of $G$.
\end{proof}
