...
\begin{prp}
Aggregate welfare is weakly decreasing in $(1-\eta)\tau_y$ and strictly decreasing over any range of policies whose implied thresholds lie in the support of $G$.
\end{prp}
\begin{proof}
From (\ref{eq:nthreshold}) and $F>\mathcal{N}$, $\underline w_y$ increases with $(1-\eta)\tau_y$.
