...
\end{prp}
\begin{proof}
By (\ref{eq:nthreshold}) and $F>\mathcal{N}$, $\underline w_y$ increases with $(1-\eta)\tau_y$. Since $G$ is increasing, the fraction of young individuals below the threshold also increases. Equation (\ref{eq:aggW}) then implies that aggregate welfare decreases, because $\mathcal{N}>0$. The decrease is strict whenever $\underline w_y$ lies in the support of $G$.
\end{proof}
